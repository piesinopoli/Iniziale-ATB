...
if (clientIDint>-1)
    ...
    annotation(figure1,'textbox',[0.28 0.5 0.5 0.45], ...
    'String',{'SCEGLI UN COMANDO:'}, ...
    'FontSize',15, ...
    'FitBoxToText','off', ... 
    'EdgeColor','none');

    btn = uicontrol('Style', 'pushbutton', 'String', {'SINISTRA'},...
    'Position',  [20 220 200 100],...
    'Callback', @ATBmoveDx);

    btn2 = uicontrol('Style', 'pushbutton', 'String', {'DESTRA'},...
    'Position',  [340 220 200 100],...
    'Callback', @ATBmoveSx);

    btn3 = uicontrol('Style', 'pushbutton', 'String', {'SCREEN'},...
    'Position',  [180 100 200 100],...
    'Callback', @ATBscreen);

    btn4 = uicontrol('Style', 'pushbutton', 'String', {'ESCI'},...
